// This crate contains the main modules of the application.
// It defines the domain, infrastructure, application and presentation layers.
pub mod Domain;         // Corregir capitalización
